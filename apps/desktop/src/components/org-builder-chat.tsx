...
export function OrgBuilderChat(props: {
  ...
  return (
    <div class="flex min-h-0 flex-1 flex-col">
      {/* No header of its own: the AULAR button in the org header names this
          panel and toggles it, so the timeline runs from the very top — the
          channel component the chat register renders, bound to the same
          active conversation. */}
      <MessageList />
